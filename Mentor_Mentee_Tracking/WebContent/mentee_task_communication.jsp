...
<html>
	<head>
	<meta charset="UTF-8">
	<title>Mentee Task Communication</title>
	...
	<%
		try{
			...
			if(total_messages == 0){
				%>
				<div class="container">
					<form action="mentee_message_confirm.jsp" method="POST">
						...
						<div class="form-group">
							...
							<input type="hidden" name="taskID2" value="<%=taskID%>">
							<input type="hidden" name="mentee_name2" value="<%=mentee_name%>">
