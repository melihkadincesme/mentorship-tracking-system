...
<html>
	<head>
	<meta charset="UTF-8">
	<title>Communication Mentor</title>
	...
	<div class="container">
			<form action="comMentor_confirm.jsp" method="POST"
				id="my-form">
				
				<div class="form-group">
					 
					<input list="category16" name="category16" placeholder="Choose your communication type...">
					 
					<datalist id="category16">
