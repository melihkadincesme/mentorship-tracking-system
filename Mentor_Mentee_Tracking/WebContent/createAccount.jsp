...
<html>
	...
	<style>
		...
		#parag1, #parag2, #parag3, #parag4, #parag5, #parag6, #parag7, #parag8 {
			color:white;
		}
	...
	<form class="box" action="createAccountConfirm.jsp" method = "get">
		<h1>Mentor Create Account</h1>
			<table>
			<%
			try{
				...
				String get_dept_name = "Select dept_name from department where unique_code=?";
				...
				%>
		 			...
		 			<tr>
		 				<td id="parag6">Department Name</td><td>
